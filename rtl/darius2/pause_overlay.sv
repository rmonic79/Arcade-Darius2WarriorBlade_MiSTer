...
// VBlank pulse: rilevato all'ingresso vblank (render_y attraversa 240).
// triple_screen_test ha V_ACTIVE=240 (warriorb max), V_TOTAL=262.
// Pulse di 1 ciclo quando render_y passa da 239 a 240.
reg [8:0] render_y_d;
always @(posedge clk) render_y_d <= render_y;
wire vblank_pulse = (render_y == 9'd240) && (render_y_d == 9'd239);
